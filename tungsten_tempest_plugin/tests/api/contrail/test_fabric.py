...
class FabricContrailTest(rbac_base.BaseContrailTest):
    ...
    @rbac_rule_validation.action(service="Contrail",
                                 rules=["list_fabrics"])
    @idempotent_id('9005d1d6-3bd2-4378-b145-0fda130ce1d1')
    ...
    @rbac_rule_validation.action(service="Contrail",
                                 rules=["create_fabric"])
    @idempotent_id('9b216ca5-b332-41ca-9072-6c3ee325ea91')
    ...
    @rbac_rule_validation.action(service="Contrail",
                                 rules=["show_fabric"])
    @idempotent_id('244c3530-70e0-4efe-98be-4c2d1ffa0376')
    ...
    @rbac_rule_validation.action(service="Contrail",
                                 rules=["delete_fabric"])
    @idempotent_id('75edc6b9-c66a-46fc-a271-4c54e4cc77b1')
    ...
    @rbac_rule_validation.action(service="Contrail",
                                 rules=["update_fabric"])
    @idempotent_id('f22c4c26-3843-4fc6-a8ff-7890d5ad1c39')
